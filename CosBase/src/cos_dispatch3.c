/*
 ...
 o---------------------------------------------------------------------o
 |
 | $Id: cos_dispatch3.c,v 1.3 2008/10/02 14:50:35 ldeniau Exp $
 |
*/
...
__thread struct cos_method_cache3 cos_method_cache3_ = { &cache_empty, 0 };
...
{
  struct cos_method_cache3 *cache = pthread_getspecific(_cache_key);
