...
/*
 ...
 o---------------------------------------------------------------------o
 |
 | $Id: Tuple.h,v 1.1 2008/10/25 13:12:59 ldeniau Exp $
 |
*/
...
#define aTuple(...)  ( (OBJ)atTuple(__VA_ARGS__) )
#define atTuple(...) atTupleN(COS_PP_NARG(__VA_ARGS__),__VA_ARGS__)

#define aTuple_(N,...) ( &(struct COS_PP_CAT(Tuple,N)) { \
